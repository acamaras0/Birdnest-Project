...
db.connect(function (err) {
  ...
  db.query(
    "CREATE TABLE IF NOT EXISTS pilots (id INT AUTO_INCREMENT PRIMARY KEY, firstname VARCHAR(255), lastname VARCHAR(255) , email VARCHAR(255), phone VARCHAR(255), distance DOUBLE ,timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP)",
    (err, result) => {
      if (err) throw err;
